...
<body ng-app="myapp">
	<div class="container" id="productTable"
		...
		<p>The List of Items in our Database</p>
				...
				<c:forEach items="${products}" var="prod">
					<tr>
						<td style="width: 171px"><img
							src="<c:url value="/resource/images/${prod.productId}.jpg"/>"
							style="width: 100px; height: 90px;">${prod.productName}"  /></td>
						<td>${prod.productId}</td>
						<td>${prod.productName}</td>
						<td>${prod.productType}</td>
						<td>${prod.productCuisine}</td>
						...
						<td ng-controller="myController"><a
							...
							<!-- 						view only to the admin --> <security:authorize
								...
								<a href="#" ng-if="${prod.itemStatus}==true" ng-click="disableItem(${prod.productId})"
								   ng-class="{'glyphicon glyphicon-eye-close' : toggle,'glyphicon glyphicon-eye-open':!toggle}"
								   class="btn btn-default"
								   style="margin-left: 5px"> </a>
								<a href="#" ng-if="${prod.itemStatus}==false" ng-click="enableItem(${prod.productId})"
