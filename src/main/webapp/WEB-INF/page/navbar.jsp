...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<c:url value="/index1" />">QuickFood</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				<li><a href=" <c:url value="/index1" />">Home</a></li>
				<li><a href=" <c:url value="/getAllProducts" />">Menu</a></li>
				...
				<security:authorize access="hasRole('ROLE_ADMIN')">
					<%--<li><a href=" <c:url value="/admin/product/addProduct" />">Add
							Item</a></li>--%>
					<li><select name ="menu" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
						<li><option style='display:none' disabled="disabled" selected="selected">Menu</option></li>
						<li><option value="/admin/product/addProduct">Add Product</option></li>
						<li><option value="/getAllProducts">Edit/Delete/Enable-Disable</option></li>
						<li><option value="http://google.com">Preview</option></li>
					</select></li>
				</security:authorize>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${!empty pageContext.request.userPrincipal.name}">
					...
					<security:authorize access="hasRole('ROLE_USER')">
						...
						<li><a href="<c:url value="/orderList" />"> Ordered Items</a></li>
					</security:authorize>
